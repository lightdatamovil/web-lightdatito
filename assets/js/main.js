            ...
            searchInput.each(function () {
                ...
                searchInput
                    .typeahead(
                        ...
                        // Pages
                        {
                            ...
                            templates: {
                                ...
                                header: '<h6 class="suggestions-header text-primary mb-0 mx-3 mt-3 pb-2">Modulos</h6>',
                                suggestion: function ({ ruta, icon, name }) {
                                    // return '<a href="' + url + '">' + "<div>" + '<i class="' + icon + ' me-2"></i>' + '<span class="align-middle">' + name + "</span>" + "</div>" + "</a>"
                                    return '<a href="/' + ruta + '" data-route="' + ruta + '">' + "<div>" + '<i class="' + icon + ' me-2"></i>' + '<span class="align-middle">' + name + "</span>" + "</div>" + "</a>"
                                },
                                ...
                                notFound: '<div class="not-found px-3 py-2">' + '<h6 class="suggestions-header text-primary mb-2">Modulos</h6>' + '<p class="py-2 mb-0"><i class="ri-warning-line me-2 ri-14px"></i> No se encontraron resultados</p>' + "</div>",
                            },
                        }
                        // Files
                        // {
                    ...
                    .bind("typeahead:select", function (ev, suggestion) {
                        ...
                        // }
                        if (suggestion.ruta) {
                            navigateTo("/" + suggestion.ruta.replace(/^\//, ""))
                        }
                    })
                    // On typeahead close
